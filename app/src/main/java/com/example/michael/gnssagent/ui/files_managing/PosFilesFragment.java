...
public class PosFilesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(R.layout.fragment_pos_files, container, false);

        lv = rootView.findViewById(R.id.posFilesListView);
    ...
    private ArrayList<LogFile> getAllFiles() {
        ...
        if (logFiles.exists() && logFiles.listFiles() != null) {
            for (File file : logFiles.listFiles()) {
                ...
                if (fileNameSplit[fileNameSplit.length-1].equals("pos.txt")) {
                    files.add(f);
                }
            }
        }
